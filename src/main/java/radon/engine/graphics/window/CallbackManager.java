...
import radon.engine.events.input.keyboard.KeyEvent;
...
import radon.engine.events.window.*;
...
import static radon.engine.events.EventManager.triggerEvent;
import static radon.engine.events.EventManager.triggerEventNow;
...
class CallbackManager implements Resource {
    ...
    CallbackManager setup(Window window) {
        ...
        EventManager.addEventCallback(WindowClosedEvent.class, e -> RadonApplication.exit());
