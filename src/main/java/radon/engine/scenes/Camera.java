...
import radon.engine.util.geometry.Viewport;
import radon.engine.util.geometry.Viewportc;

import static java.util.Objects.requireNonNull;
import static org.joml.Math.max;
import static radon.engine.util.Asserts.assertNonNull;
import static radon.engine.util.Maths.*;
...
public final class Camera {
    ...
    public Camera(CameraInfo cameraInfo) {
        ...
        this.cameraInfo = requireNonNull(cameraInfo);
    ...
    public Matrix4f getProjectionMatrix(Matrix4f projectionMatrix, ProjectionType projectionType) {
        ...
        if (projectionType == ProjectionType.PERSPECTIVE) {
            ...
            //projectionMatrix.setOrtho(-w/2.0f, w/2.0f, -h/2.0f, h/2.0f, nearPlane, farPlane);
            //projectionMatrix.setOrtho(-ff, ff, -ff, ff, nearPlane, farPlane);
            //projectionMatrix.setOrtho(-1, 1, -1, 1, nearPlane, farPlane);
        }
